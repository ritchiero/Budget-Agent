...
def setup_datadog_telemetry():
    ...
    if dd_api_key:
        ...
        os.environ["OTEL_EXPORTER_OTLP_TRACES_ENDPOINT"] = f"https://api.{dd_site}/api/intake/otlp/v1/traces"
        ...
        print("⚠️  DD_API_KEY not set. Running without Datadog telemetry.")
...
Use comparisons that make costs tangible (e.g., "that's $X/month, enough for Y").
